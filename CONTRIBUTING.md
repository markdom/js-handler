# Contributing to JAVASCRIPT Markdom Handler
...
Here’s an example workflow for `js-handler` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/js-handler`
- Clone your project  

```
git clone git@git.markenwerk.net:yourname/js-handler.git
```
